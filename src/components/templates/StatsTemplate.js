...
const StatsTemplate = () => {
  ...
  return (
    <>
      <Center>
        <Heading  mt={{sm:"3rem",lg:"8rem"}} ml={{md:"6rem"}} fontSize="4xl" fontFamily="mono">Vos stats ComEth</Heading>
      </Center>
      <Box backgroundColor="blackAlpha.200" ml={{sm:"2rem",md:"12rem",lg:"16rem"}} mr={{sm:"2rem"}} rounded="md" mt="4rem" p="2rem" width={{sm:"90%",md:"75%",lg:"50%"}} maxW="35rem" h="55%">
